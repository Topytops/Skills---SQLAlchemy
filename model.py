...
class Model(db.Model):
    ...
    def __repr__(self):
        """Show info about the cars's models"""

        return "<Model id=%s year=%s brand_name=%s" %(self.id, self.year, self.brand_name)
...
class Brand(db.Model):
    ...
    model_brand = db.relationship(Model,
    ...
    def __repr__(self):
        """Show info about the car's brand"""
